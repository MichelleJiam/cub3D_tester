...
#    Updated: 2020/06/19 14:39:02 by mjiam         ########   odam.nl          #
#                                                                              #
# **************************************************************************** #
...
if [ ! -f "../cub3D" ]; then
    ...
    read -s -n 1 KEY
    if [$KEY == ""] ; then
        printf "\n${BLUE}Test ${TNUM}/25: invalid sprite texture file${RESET}\n"
    ...
    read -s -n 1 KEY
    if [$KEY == ""] ; then
        printf "\n${CYAN}Test ${TNUM}/25: invalid open map #2 (sprite)${RESET}\n"
    ...
    read -s -n 1 KEY
    if [$KEY == ""] ; then
        printf "\n${CYAN}Test ${TNUM}/25: map full of sprites. Should render correctly.${RESET}\n"
    ...
    read -s -n 1 KEY
    if [$KEY == ""] ; then
        printf "\n${PURP}Test ${TNUM}/25: 3600x2800 resolution with --SAVE. Should not resize.${RESET}\n"
